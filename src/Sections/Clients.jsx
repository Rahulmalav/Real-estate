...
const Clients = () => {
  ...
  return (
    ...
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
      <section id='testimonial' className={` lg:w-[95%] w-full h-fit m-auto rounded-xl flex flex-col justify-center items-start lg:px-20 px-6 py-20 gap-20`}>
        <div className='flex flex-col justify-center items-start gap-4' >
          <h1 data-aos='zoom-in' className='text-red-500 dark:text-white'  >OUR CLIENTS</h1>
          <h1 data-aos='zoom-in' className='text-black text-[40px] font-semibold leading-10 dark:text-white ' >What our clients <br></br> saying  about us </h1>
        </div>
              ...
              <div data-aos="zoom-in" data-aos-delay="200" className='bg-white dark:bg-gray-900 hover:bg-red-100 cursor-pointer p-12 flex flex-col justify-center items-center gap-6 rounded-xl w-full  ' >
                <div className='flex justify-start items-center w-full gap-4' >
                  ...
                  <div className='flex flex-col justify-center items-start gap-1' >
                    <h1 className='text-xl text-black font-semibold dark:text-white' > {item.text} </h1>
                    <h1 className='text-slate-600 dark:text-white' >{item.text}</h1>
                  </div>
                </div>
                <p className='text-md text-justify text-slate-600 items-start gap-2 w-full ' >{item.feedback}</p>
